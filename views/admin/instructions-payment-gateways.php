...
<ol>
	...
	<li><?php echo sprintf( __('Hover over the %s subtab on the top navigation area and click the %s link', 'wpet'), '<strong>Profile</strong>', '<strong>My Selling Tools</strong>' ); ?></li>
	<li><?php echo sprintf( __('Click %s on the API Access line', 'wpet'), '<strong>update</strong>' ); ?></li>
	<li><?php echo sprintf( __('Click the %s link (under Option 2)', 'wpet'), '<strong>request api credentials</strong>' ); ?></li>
	<li><?php echo sprintf( __('Submit the form to %s', 'wpet'), '<strong>request api signature</strong>' ); ?></li>
