...
<table class="form-table">
	<tbody>
		<tr>
			...
			<td>
				<label><input type="checkbox" name="options[show_package_count]" id="options[show_package_count]" value="1"></label>
			</td>
		</tr>
		<tr>
			<th scope="row"><label for="options[hide_coupons]"><?php _e('Hide coupons', 'wpet'); ?></label></th>
			<td>
				<input type="checkbox" name="options[hide_coupons]" id="options[hide_coupons]" value="1">
			</td>
		</tr>
	</tbody>
</table>
