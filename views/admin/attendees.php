<div class="wrap">
	...
	<h2><?php _e('Attendees', 'wpet'); ?> <a href="?page=wpet_attendees&add-attendee=1" class="add-new-h2">Add New</a></h2>

	<form action="" method="get" class="search-form">
		<p class="search-box">
			<label class="screen-reader-text" for="all-package-search-input">Search Attendees:</label>
			<input type="search" id="all-user-search-input" name="s" value="">
			<input type="submit" name="" id="search-submit" class="button" value="Search Attendees"></p>
	</form>
<?php
// @TODO
// fix nonce
