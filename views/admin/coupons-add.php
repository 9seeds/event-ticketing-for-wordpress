	...
	<table class="form-table">
		<tbody>
			<tr class="form-field form-required">
				...
				<td><input name="options[coupon-code]" id="coupon_code" type="text" value=""></td>
			</tr>
			<tr class="form-field form-required">
			...
			<tr class="form-field form-required">
				...
				<td><input name="options[amount]" id="amount" type="text" value=""></td>
			</tr>
			<tr class="form-field form-required">
				<th scope="row"><label for="quantity"><?php _e('Quantity', 'wpet'); ?></label></th>
				<td><input name="options[quantity]" id="quantity" type="text" value=""></td>
			</tr>
